...
export default function RegisterPage() {
	...
	const handlePasskeySignUp = async () => {
		// Note: Passkey sign up usually requires email and name first
		// In a real app, you might validate the form first, then call passkey
		toast.info("Please fill in your email and name, then click 'Sign up with Passkey'.");
	};
